...
class ShareFolderHost extends Events.EventEmitter {
    ...
    createInstance() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const ALLOWED_IPS = Enumerable.from(sf_helpers.asArray(this.options.allowed).map(a => sf_helpers.normalizeString(a))
                .filter(a => '' !== a)
                .map(a => {
                if (a.indexOf('/') < 0) {
                    if (IP.isV4Format(a)) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const GET_DIRECTORY_ENTRY = function (p, n) {
                return __awaiter(this, arguments, void 0, function* () {
                    p = sf_helpers.toStringSafe(p);
                    const STAT = yield FSExtra.lstat(p);
                    return TO_DIRECTORY_ENTRY(yield FSExtra.lstat(p), arguments.length < 2 ? Path.basename(p)
            ...
            // file content / info
            app.get('/:path?', (req, resp) => __awaiter(this, void 0, void 0, function* () {
                ...
                const SELF_STAT = yield FSExtra.lstat(FILE_OR_FOLDER);
                if (SELF_STAT.isDirectory()) {
                    ...
                    for (const NAME of LIST) {
                        ...
                        const STAT = yield FSExtra.lstat(FULL_PATH);
                        RESULT.push({
                            ctime: sf_helpers.asUTC(STAT.ctime).toISOString(),
                            mtime: sf_helpers.asUTC(STAT.mtime).toISOString(),
                            name: NAME,
            ...
            // create directory
            app.post('/:path?', (req, resp) => __awaiter(this, void 0, void 0, function* () {
                const REQUESTED_PATH = sf_helpers.normalizePath(req.params.path);
            ...
            // write (new) file
            app.put('/:path?', (req, resp) => __awaiter(this, void 0, void 0, function* () {
                const REQUESTED_PATH = sf_helpers.normalizePath(req.params.path);
                if (IS_OUTSIDE(REQUESTED_PATH) || ('/' === REQUESTED_PATH)) {
                    return resp.status(400)
                        .send();
            ...
            app.delete('/:path?', (req, resp) => __awaiter(this, void 0, void 0, function* () {
                const REQUESTED_PATH = sf_helpers.normalizePath(req.params.path);
                if (IS_OUTSIDE(REQUESTED_PATH) || ('/' === REQUESTED_PATH)) {
                    return resp.status(400)
                        .send();
                ...
                const STAT = yield FSExtra.lstat(FILE_OR_FOLDER);
                if (STAT.isDirectory()) {
